...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/html-to-markdown/releases/download/v3.11.5/HtmlToMarkdown-rs.artifactbundle.zip",
      checksum: "e17bfa2afc77662307ce14f3ea201e3a463c2465c9eab70258b93d149de4e646"
    ),
