...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/html-to-markdown/releases/download/v3.11.2/HtmlToMarkdown-rs.artifactbundle.zip",
      checksum: "00db0f92d089d4611ee85d213c7bf076eeb10fbca2176d80b6298f8e8078f124"
    ),
