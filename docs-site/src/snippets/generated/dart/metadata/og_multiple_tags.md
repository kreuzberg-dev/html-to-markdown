...
<!-- alef:hash:edd93893c08cc339536865e4862de8995930be327d4b898c302057cae803f44e -->
...
Future<void> main() async {
  ...
  try {
    ...
    stdout.writeln(result.metadata.document.openGraph["type"]);
    stdout.writeln(result.metadata.document.openGraph["url"]);
    stdout.writeln(result.metadata.document.openGraph["site_name"]);
  } finally {
    RustLib.dispose();
  }
}
