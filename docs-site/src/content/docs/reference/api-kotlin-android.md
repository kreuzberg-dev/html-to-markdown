...
<!-- alef:hash:9e07e8970c6c474609972c984763abe2eabf397effa5d39352373b9ab91bcd26 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Kotlin (Android) API Reference <span class="version-badge">v3.11.5</span>
...
| `rowSpan` | `Int` | `default_span()` | Number of rows this cell spans (default 1). |
| `colSpan` | `Int` | `default_span()` | Number of columns this cell spans (default 1). |
