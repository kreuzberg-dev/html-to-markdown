...
<!-- alef:hash:0a7b73e2dc5e05e4a9cf7c26d52b92b6311a96827f743104677a3e708777a691 -->
...
| `RowSpan` | `uint` | `default_span()` | Number of rows this cell spans (default 1). |
| `ColSpan` | `uint` | `default_span()` | Number of columns this cell spans (default 1). |
