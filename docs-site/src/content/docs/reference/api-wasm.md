...
<!-- alef:hash:ea27f5d341fbbfdd7024215638c320dfc135827586a0ccc7a95b17e768b0ec56 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## WebAssembly API Reference <span class="version-badge">v3.11.6</span>
...
| `rowSpan` | `number` | `default_span()` | Number of rows this cell spans (default 1). |
| `colSpan` | `number` | `default_span()` | Number of columns this cell spans (default 1). |
