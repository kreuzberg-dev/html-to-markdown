...
## Java API Reference <span class="version-badge">v3.10.6</span>
...
```java
public static ConversionResult convert(String html, ConversionOptions options) throws ConversionError
```
...
**Errors:** Throws `ConversionErrorException`.
