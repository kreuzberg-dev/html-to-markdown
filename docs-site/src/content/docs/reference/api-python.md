...
<!-- alef:hash:c6550eaab5c2c21cc67aac0e1bd18d83792e5404599d46b67c95d299aeb001ab -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Python API Reference <span class="version-badge">v3.11.4</span>
...
| `row_span` | `int` | `default_span()` | Number of rows this cell spans (default 1). |
| `col_span` | `int` | `default_span()` | Number of columns this cell spans (default 1). |
