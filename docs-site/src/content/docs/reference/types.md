...
<!-- alef:hash:349e46a87961725067bac474f14a1a47865bff80c0439aa64011173c1c415214 -->
...
| `Custom` | `custom` | Replace default output with custom markdown The visitor takes full responsibility for the markdown output of this node and its children. — Fields: `_0`: `String` |
...
| `Error` | `error` | Stop conversion with an error The conversion process halts and returns this error message. — Fields: `_0`: `String` |
