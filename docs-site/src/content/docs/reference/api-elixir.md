...
<!-- alef:hash:fc8c4d99a5a257b46187ab7cd006cc705f80e775b1eee5810297918d62adc121 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Elixir API Reference <span class="version-badge">v3.12.0</span>
...
| `row_span` | `integer()` | `default_span()` | Number of rows this cell spans (default 1). |
| `col_span` | `integer()` | `default_span()` | Number of columns this cell spans (default 1). |
