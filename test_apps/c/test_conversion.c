...
void test_blockquote_code_block_indentation_preserved(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<blockquote><pre><code>line1\n    line2 "
...
void test_blockquote_nested_list_indentation_preserved(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<blockquote><ul><li>item a<ul><li>sub "
...
void test_blockquote_simple(void) {
  /* Simple blockquote */
  HTMConversionResult *result =
      htm_convert("<blockquote><p>Quote text</p></blockquote>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_blockquote_text_then_paragraph_gets_blank_line(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<blockquote>Just text, then <p>a paragraph</p></blockquote>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_bold_and_italic(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p><strong><em>both</em></strong></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_bold_strong(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p><strong>bold</strong></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_code_block(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<pre><code class=\"language-python\">print('hello')</code></pre>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_code_block_no_language(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<pre><code>plain code here</code></pre>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_code_inline_in_paragraph(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<p>Call the <code>initialize()</code> method first.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_conversion_autolink_filename_not_autolinked(void) {
   ...
   * (#397) */
  HTMConversionResult *result =
      htm_convert("<a href=\"foobar.png\">foobar.png</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "[foobar.png](foobar.png)") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_conversion_autolink_https_url(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<a href=\"https://example.com\">https://example.com</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "<https://example.com>") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_conversion_autolink_mailto(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<a href=\"mailto:a@b.com\">a@b.com</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_conversion_autolink_mixed_filename_and_url(void) {
  ...
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content,
                     "[foobar.png](foobar.png) <https://www.heise.de>") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_emphasis_mark_highlight(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p><mark>highlighted</mark></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_emphasis_strikethrough_del(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p><del>deleted text</del></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_emphasis_strikethrough_s(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p><s>strikethrough</s></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_heading_h2(void) {
  ...
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "## Heading 2") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h3(void) {
  ...
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "### Heading 3") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h4(void) {
  ...
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "#### Heading 4") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h5(void) {
  ...
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "##### Heading 5") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h6(void) {
  ...
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(str_trim_eq(content, "###### Heading 6") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_image_simple(void) {
  /* Image with alt text */
  HTMConversionResult *result =
      htm_convert("<img src=\"photo.jpg\" alt=\"A photo\">", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_image_with_title(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL &&
...
void test_line_break_br_tag(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p>First line.<br>Second line.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_line_break_hr_tag(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p>Before rule.</p><hr><p>After rule.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_link_anchor_fragment(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<a href=\"#section\">Jump to section</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL &&
...
void test_link_empty_href(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<a href=\"\">No destination</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_link_simple(void) {
  /* Simple link */
  HTMConversionResult *result =
      htm_convert("<a href=\"https://example.com\">Example</a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL &&
...
void test_link_with_bold_text(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<a href=\"https://example.com\"><strong>Bold link</strong></a>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_list_mixed_nested(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub "
...
void test_paragraph_nested_divs(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<div><div><p>Nested text</p></div></div>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_paragraph_with_line_breaks(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p>Line one.<br>Line two.<br>Line three.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_abbr(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_semantic_article(void) {
  ...
  HTMConversionResult *result = htm_convert(
      "<article><h2>Article Title</h2><p>Article body.</p></article>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_semantic_hr(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p>Above</p><hr><p>Below</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_mark_highlight(void) {
  /* Mark tag produces highlighted output */
  HTMConversionResult *result = htm_convert(
      "<p>This is <mark>highlighted text</mark> in a sentence.</p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_sub_superscript(void) {
  ...
  HTMConversionResult *result =
      htm_convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
  assert(content != NULL && strstr(content, "H") != NULL &&
...
void test_unordered_list(void) {
  /* Unordered list */
  HTMConversionResult *result = htm_convert(
      "<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", NULL);
  assert(result != NULL && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
