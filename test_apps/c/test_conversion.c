 ...
 * alef:hash:84b38974997b6f7d0ecc6a596fda66081228d4273db55f7dbc5745155193add2
...
void test_conversion_autolink_filename_not_autolinked(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "[foobar.png](foobar.png)") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_conversion_autolink_https_url(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "<https://example.com>") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_conversion_autolink_mailto(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "<a@b.com>") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_conversion_autolink_relative_path_not_autolinked(void) {
  ...
  char *content = htm_conversion_result_content(result);
  assert(content != NULL &&
         strcmp(content, "[/docs/intro.html](/docs/intro.html)") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h1(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "# Heading 1") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h2(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "## Heading 2") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h3(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "### Heading 3") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h4(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "#### Heading 4") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h5(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "##### Heading 5") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_heading_h6(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "###### Heading 6") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_paragraph_simple(void) {
  ...
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strcmp(content, "Hello World") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
