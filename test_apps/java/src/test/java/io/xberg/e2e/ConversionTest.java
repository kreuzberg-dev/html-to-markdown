...
public class ConversionTest {
  ...
  void testBlockquoteMultipleParagraphs() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<blockquote><p>First paragraph.</p><p>Second "
  ...
  void testBlockquoteNested() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<blockquote><p>Outer quote.</p><blockquote><p>Inner "
    ...
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Outer quote."),
               "expected to contain: "
                   + "Outer quote.");
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Inner quote."),
               "expected to contain: "
                   + "Inner quote.");
  }
  ...
  void testBlockquoteSimple() throws Exception {
    // Simple blockquote
    var result =
        HtmlToMarkdownRs.convert("<blockquote><p>Quote text</p></blockquote>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testBlockquoteWithList() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point "
            + "two</li></ul></blockquote>",
        ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testBoldAndItalic() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<p><strong><em>both</em></strong></p>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testBoldStrong() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><strong>bold</strong></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testCodeBlockNoLanguage() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<pre><code>plain code here</code></pre>",
                                 ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testConversionAutolinkFilenameNotAutolinked() throws Exception {
    ...
    // (#397)
    var result =
        HtmlToMarkdownRs.convert("<a href=\"foobar.png\">foobar.png</a>",
                                 ConversionOptions.builder().build());
    assertEquals("[foobar.png](foobar.png)",
                 java.util.Optional.ofNullable(result.content())
                     .map(java.util.Objects::toString)
                     .orElse("")
                     .trim());
  }
  ...
  void testConversionAutolinkMailto() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<a href=\"mailto:a@b.com\">a@b.com</a>",
                                 ConversionOptions.builder().build());
    assertEquals("<a@b.com>", java.util.Optional.ofNullable(result.content())
                                  .map(java.util.Objects::toString)
                                  .orElse("")
                                  .trim());
  }
  ...
  void testConversionAutolinkMixedFilenameAndUrl() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<a href=\"foobar.png\">foobar.png</a> <a "
  ...
  void testConversionAutolinkRelativePathNotAutolinked() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<a href=\"/docs/intro.html\">/docs/intro.html</a>",
        ConversionOptions.builder().build());
  ...
  void testEmphasisMarkHighlight() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><mark>highlighted</mark></p>",
                                          ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testEmphasisStrikethroughDel() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><del>deleted text</del></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testEmphasisStrikethroughS() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><s>strikethrough</s></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testEmphasisSubscript() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p>H<sub>2</sub>O</p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testEmphasisSuperscript() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p>x<sup>2</sup></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testEmphasisUnderlineU() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><u>underlined</u></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testFormInputElements() throws Exception {
    ...
    var options =
        JsonUtil.fromJson("{\"preprocessing\":{\"remove_forms\":false}}",
                          ConversionOptions.class);

    var result = HtmlToMarkdownRs.convert(
        "<form><label for=\"name\">Name:</label><input type=\"text\" "
  ...
  void testFormSelectOptions() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<form><label>Color:</label><select><option "
  ...
  void testFormTextarea() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<form><label>Message:</label><textarea>Default text "
  ...
  void testHeadingH1() throws Exception {
    // H1 heading
    var result = HtmlToMarkdownRs.convert("<h1>Heading 1</h1>",
                                          ConversionOptions.builder().build());
    assertEquals("# Heading 1", java.util.Optional.ofNullable(result.content())
                                    .map(java.util.Objects::toString)
                                    .orElse("")
                                    .trim());
  }
  ...
  void testHeadingH2() throws Exception {
    // H2 heading
    var result = HtmlToMarkdownRs.convert("<h2>Heading 2</h2>",
                                          ConversionOptions.builder().build());
    assertEquals("## Heading 2", java.util.Optional.ofNullable(result.content())
                                     .map(java.util.Objects::toString)
                                     .orElse("")
                                     .trim());
  }
  ...
  void testHeadingH3() throws Exception {
    // H3 heading
    var result = HtmlToMarkdownRs.convert("<h3>Heading 3</h3>",
                                          ConversionOptions.builder().build());
  ...
  void testHeadingH4() throws Exception {
    // H4 heading
    var result = HtmlToMarkdownRs.convert("<h4>Heading 4</h4>",
                                          ConversionOptions.builder().build());
  ...
  void testHeadingH5() throws Exception {
    // H5 heading
    var result = HtmlToMarkdownRs.convert("<h5>Heading 5</h5>",
                                          ConversionOptions.builder().build());
  ...
  void testHeadingH6() throws Exception {
    // H6 heading
    var result = HtmlToMarkdownRs.convert("<h6>Heading 6</h6>",
                                          ConversionOptions.builder().build());
  ...
  void testImageFigureFigcaption() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<figure><img src=\"sunset.jpg\" alt=\"A "
            + "sunset\"><figcaption>Beautiful sunset over "
            + "the ocean</figcaption></figure>",
        ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("![A sunset](sunset.jpg)"),
               "expected to contain: "
                   + "![A sunset](sunset.jpg)");
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Beautiful sunset over the ocean"),
               "expected to contain: "
  ...
  void testImageLinked() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<a href=\"https://example.com\"><img "
                                     + "src=\"icon.png\" alt=\"Icon\"></a>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("![Icon](icon.png)"),
               "expected to contain: "
                   + "![Icon](icon.png)");
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
  ...
  void testImageNoAlt() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<img src=\"banner.jpg\">",
                                          ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testImageSimple() throws Exception {
    // Image with alt text
    var result =
        HtmlToMarkdownRs.convert("<img src=\"photo.jpg\" alt=\"A photo\">",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("![A photo](photo.jpg)"),
               "expected to contain: "
                   + "![A photo](photo.jpg)");
  }
  ...
  void testImageWithTitle() throws Exception {
    ...
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("![Sales chart](chart.png"),
               "expected to contain: "
  ...
  void testItalicEm() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p><em>italic</em></p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testLineBreakBrTag() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p>First line.<br>Second line.</p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testLineBreakHrTag() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<p>Before rule.</p><hr><p>After rule.</p>",
                                 ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testLineBreakMultipleBr() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p>Start.<br><br>End.</p>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testLinkAnchorFragment() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<a href=\"#section\">Jump to section</a>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("[Jump to section](#section)"),
               "expected to contain: "
  ...
  void testLinkEmptyHref() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<a href=\"\">No destination</a>",
                                          ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testLinkMailto() throws Exception {
    ...
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("mailto:user@example.com"),
               "expected to contain: "
  ...
  void testLinkSimple() throws Exception {
    // Simple link
    var result =
        HtmlToMarkdownRs.convert("<a href=\"https://example.com\">Example</a>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testListDefinitionDl() throws Exception {
    ...
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Definition of term one."),
               "expected to contain: "
    ...
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Definition of term two."),
               "expected to contain: "
  ...
  void testListItemMultipleParagraphs() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<ul><li><p>First paragraph in item.</p><p>Second paragraph in "
            + "item.</p></li><li>Simple item</li></ul>",
        ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("First paragraph in item."),
               "expected to contain: "
                   + "First paragraph in item.");
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Second paragraph in item."),
               "expected to contain: "
                   + "Second paragraph in item.");
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
                   .contains("Simple item"),
               "expected to contain: "
                   + "Simple item");
  }
  ...
  void testListMixedNested() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub "
  ...
  void testListNestedOrdered() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<ol><li>Step 1<ol><li>Step 1a</li><li>Step "
  ...
  void testListNestedUnordered() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<ul><li>Parent A<ul><li>Child A1</li><li>Child "
  ...
  void testParagraphNestedDivs() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<div><div><p>Nested text</p></div></div>",
                                 ConversionOptions.builder().build());
    assertTrue(java.util.Optional.ofNullable(result.content())
                   .map(java.util.Objects::toString)
                   .orElse("")
  ...
  void testParagraphWithInlineFormatting() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<p>This has <strong>bold</strong>, <em>italic</em>, and a <a "
  ...
  void testParagraphWithLineBreaks() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<p>Line one.<br>Line two.<br>Line three.</p>",
                                 ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testSemanticDetailsSummary() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<details><summary>Click to expand</summary><p>Hidden content "
            + "here.</p></details>",
        ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
  ...
  void testSemanticHr() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<p>Above</p><hr><p>Below</p>",
                                          ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testSemanticSubSuperscript() throws Exception {
    ...
    var result =
        HtmlToMarkdownRs.convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>",
                                 ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
  ...
  void testTableEmpty() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert("<table></table>",
                                          ConversionOptions.builder().build());
  ...
  void testTableNoThead() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</"
  ...
  void testTableWithColspan() throws Exception {
    ...
    var result = HtmlToMarkdownRs.convert(
        "<table><thead><tr><th colspan=\"2\">Full "
            + "Name</th></tr></thead><tbody><tr><td>John</"
            + "td><td>Doe</td></tr></tbody></table>",
        ConversionOptions.builder().build());
    assertFalse(java.util.Optional.ofNullable(result.content()).isEmpty(),
                "expected non-empty value");
    assertTrue(java.util.Optional.ofNullable(result.content())
