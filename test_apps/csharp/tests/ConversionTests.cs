...
// alef:hash:b87596a0283ef17d51310c584f4a7605cdd15ce8e3d4a1f3b53694dce425a7d1
...
namespace HtmlToMarkdown
{
    ...
    public class ConversionTests
    {
        ...
        [Fact]    public void Test_BlockquoteCodeBlockIndentationPreserved()
        {
    ...
    Assert.Equal("> ```\n> line1\n>     line2 indented\n> ```\n", result.Content);
        ...
        [Fact]    public void Test_BlockquoteMultipleParagraphs()
        {
    ...
    Assert.Contains("> Second paragraph.", result.Content.ToString());
        ...
        [Fact]    public void Test_BlockquoteNested()
        {
    ...
    Assert.Contains("Inner quote.", result.Content.ToString());
        ...
        [Fact]    public void Test_BlockquoteNestedListIndentationPreserved()
        {
    ...
    Assert.Equal("> - item a\n>   * sub a1\n", result.Content);
        ...
        [Fact]    public void Test_BlockquoteSimple()
        {
            // Simple blockquote
    ...
    Assert.Contains("> Quote text", result.Content.ToString());
        ...
        [Fact]    public void Test_BlockquoteTextThenParagraphGetsBlankLine()
        {
    ...
    Assert.Equal("> Just text, then\n>\n> a paragraph\n", result.Content);
        ...
        [Fact]    public void Test_BlockquoteWithList()
        {
    ...
    Assert.Contains("Point two", result.Content.ToString());
        ...
        [Fact]    public void Test_BoldAndItalic()
        {
    ...
    Assert.Contains("***both***", result.Content.ToString());
        ...
        [Fact]    public void Test_BoldStrong()
        {
    ...
    Assert.Contains("**bold**", result.Content.ToString());
        ...
        [Fact]    public void Test_CodeBlock()
        {
    ...
    Assert.Contains("print('hello')", result.Content.ToString());
        ...
        [Fact]    public void Test_CodeBlockNoLanguage()
        {
    ...
    Assert.Contains("plain code here", result.Content.ToString());
        ...
        [Fact]    public void Test_CodeInlineInParagraph()
        {
    ...
    Assert.Contains("`initialize()`", result.Content.ToString());
        ...
        [Fact]    public void Test_CodeWithBackticksInContent()
        {
    ...
    Assert.Contains("backtick", result.Content.ToString());
        ...
        [Fact]    public void Test_ConversionAutolinkFilenameNotAutolinked()
        {
    ...
    Assert.Equal("[foobar.png](foobar.png)", result.Content);

        }

        [Fact]    public void Test_ConversionAutolinkHttpsUrl()
        {
    ...
    Assert.Equal("<https://example.com>", result.Content);

        }

        [Fact]    public void Test_ConversionAutolinkMailto()
        {
    ...
    Assert.Equal("<a@b.com>", result.Content);

        }

        [Fact]    public void Test_ConversionAutolinkMixedFilenameAndUrl()
        {
    ...
    Assert.Equal("[foobar.png](foobar.png) <https://www.heise.de>", result.Content);

        }

        [Fact]    public void Test_ConversionAutolinkRelativePathNotAutolinked()
        {
    ...
    Assert.Equal("[/docs/intro.html](/docs/intro.html)", result.Content);

        }

        [Fact]    public void Test_EmphasisMarkHighlight()
        {
    ...
    Assert.Contains("highlighted", result.Content.ToString());
        ...
        [Fact]    public void Test_EmphasisStrikethroughDel()
        {
    ...
    Assert.Contains("~~deleted text~~", result.Content.ToString());
        ...
        [Fact]    public void Test_EmphasisStrikethroughS()
        {
    ...
    Assert.Contains("~~strikethrough~~", result.Content.ToString());
        ...
        [Fact]    public void Test_EmphasisSubscript()
        {
    ...
    Assert.Contains("O", result.Content.ToString());
        ...
        [Fact]    public void Test_EmphasisSuperscript()
        {
    ...
    Assert.Contains("2", result.Content.ToString());
        ...
        [Fact]    public void Test_EmphasisUnderlineU()
        {
    ...
    Assert.Contains("underlined", result.Content.ToString());
        ...
        [Fact]    public void Test_FormInputElements()
        {
    ...
    Assert.Contains("Name", result.Content.ToString());
        ...
        [Fact]    public void Test_FormSelectOptions()
        {
    ...
    Assert.Contains("Color", result.Content.ToString());
        ...
        [Fact]    public void Test_FormTextarea()
        {
    ...
    Assert.Contains("Beautiful sunset over the ocean", result.Content.ToString());
        ...
        [Fact]    public void Test_ImageLinked()
        {
    ...
    Assert.Contains("https://example.com", result.Content.ToString());
        ...
        [Fact]    public void Test_ImageNoAlt()
        {
    ...
    Assert.Contains("banner.jpg", result.Content.ToString());
        ...
        [Fact]    public void Test_ImageSimple()
        {
            // Image with alt text
    ...
    Assert.Contains("![A photo](photo.jpg)", result.Content.ToString());
        ...
        [Fact]    public void Test_ImageWithTitle()
        {
    ...
    Assert.Contains("Q3 Sales", result.Content.ToString());
        ...
        [Fact]    public void Test_InlineCode()
        {
            // Inline code
    ...
    Assert.Contains("`console.log()`", result.Content.ToString());
        ...
        [Fact]    public void Test_ItalicEm()
        {
    ...
    Assert.Contains("*italic*", result.Content.ToString());
        ...
        [Fact]    public void Test_LineBreakBrTag()
        {
    ...
    Assert.Contains("Second line.", result.Content.ToString());
        ...
        [Fact]    public void Test_LineBreakHrTag()
        {
    ...
    Assert.Contains("After rule.", result.Content.ToString());
        ...
        [Fact]    public void Test_LineBreakMultipleBr()
        {
    ...
    Assert.Contains("End.", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkAnchorFragment()
        {
    ...
    Assert.Contains("[Jump to section](#section)", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkEmptyHref()
        {
    ...
    Assert.Contains("No destination", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkImageInside()
        {
    ...
    Assert.Contains("https://example.com", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkMailto()
        {
    ...
    Assert.Contains("mailto:user@example.com", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkSimple()
        {
            // Simple link
    ...
    Assert.Contains("[Example](https://example.com)", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkWithBoldText()
        {
    ...
    Assert.Contains("https://example.com", result.Content.ToString());
        ...
        [Fact]    public void Test_LinkWithTitle()
        {
    ...
    Assert.Contains("Example Site", result.Content.ToString());
        ...
        [Fact]    public void Test_ListDefinitionDl()
        {
    ...
    Assert.Contains("Definition of term two.", result.Content.ToString());
        ...
        [Fact]    public void Test_ListItemMultipleParagraphs()
        {
    ...
    Assert.Contains("Simple item", result.Content.ToString());
        ...
        [Fact]    public void Test_ListMixedNested()
        {
    ...
    Assert.Contains("Item B", result.Content.ToString());
        ...
        [Fact]    public void Test_ListNestedOrdered()
        {
    ...
    Assert.Contains("Step 2", result.Content.ToString());
        ...
        [Fact]    public void Test_ListNestedUnordered()
        {
    ...
    Assert.Contains("Parent B", result.Content.ToString());
        ...
        [Fact]    public void Test_ListTaskCheckboxes()
        {
    ...
    Assert.Contains("Pending task", result.Content.ToString());
        ...
        [Fact]    public void Test_OrderedList()
        {
            // Ordered list
    ...
    Assert.Contains("3. Third", result.Content.ToString());
        ...
        [Fact]    public void Test_ParagraphMultiple()
        {
    ...
    Assert.Contains("Second paragraph.", result.Content.ToString());
        ...
        [Fact]    public void Test_ParagraphNestedDivs()
        {
    ...
    Assert.Contains("Nested text", result.Content.ToString());
        ...
        [Fact]    public void Test_ParagraphSimple()
        {
    ...
    Assert.Equal("Hello World", result.Content);
        ...
        [Fact]    public void Test_ParagraphWithInlineFormatting()
        {
    ...
    Assert.Contains("[link](https://example.com)", result.Content.ToString());
        ...
        [Fact]    public void Test_ParagraphWithLineBreaks()
        {
    ...
    Assert.Contains("Line three.", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticAbbr()
        {
    ...
    Assert.Contains("WWW", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticArticle()
        {
    ...
    Assert.Contains("Article body.", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticDefinitionList()
        {
    ...
    Assert.Contains("Cascading Style Sheets", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticDetailsSummary()
        {
    ...
    Assert.Contains("Click to expand", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticHr()
        {
    ...
    Assert.Contains("Below", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticMarkHighlight()
        {
            // Mark tag produces highlighted output
    ...
    Assert.Contains("highlighted text", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticSectionWithHeading()
        {
    ...
    Assert.Contains("Section content.", result.Content.ToString());
        ...
        [Fact]    public void Test_SemanticSubSuperscript()
        {
    ...
    Assert.Contains("E=mc", result.Content.ToString());
        ...
        [Fact]    public void Test_SimpleTable()
        {
    ...
    Assert.Contains("---", result.Content.ToString());
        ...
        [Fact]    public void Test_TableEmpty()
        {
    ...
    Assert.Equal("", result.Content);
        ...
        [Fact]    public void Test_TableNestedChainNotMisclassifiedAsLayout()
        {
    ...
    Assert.Contains("| ---", result.Content.ToString());
        ...
        [Fact]    public void Test_TableNoThead()
        {
    ...
    Assert.Contains("|", result.Content.ToString());
        ...
        [Fact]    public void Test_TablePipeCharsInContent()
        {
    ...
    Assert.Contains("true", result.Content.ToString());
        ...
        [Fact]    public void Test_TableRaggedRowFewerCellsThanHeader()
        {
    ...
    Assert.Equal("| A | B | C |\n| --- | --- | --- |\n| 1 | 2 |   |\n", result.Content);
        ...
        [Fact]    public void Test_TableRaggedRowMoreCellsThanHeader()
        {
    ...
    Assert.Equal("| A | B |   |\n| --- | --- | --- |\n| 1 | 2 | 3 |\n", result.Content);
        ...
        [Fact]    public void Test_TableWithAlignment()
        {
    ...
    Assert.Contains("|", result.Content.ToString());
        ...
        [Fact]    public void Test_TableWithColspan()
        {
    ...
    Assert.Contains("Doe", result.Content.ToString());
        ...
        [Fact]    public void Test_UnorderedList()
        {
            // Unordered list
