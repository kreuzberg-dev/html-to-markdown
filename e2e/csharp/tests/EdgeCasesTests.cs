...
namespace HtmlToMarkdown
{
    ...
    Assert.Contains("visible", result.Content.ToString().ToLower());
    Assert.Contains("still shown", result.Content.ToString().ToLower());
    Assert.Contains("also visible", result.Content.ToString().ToLower());
