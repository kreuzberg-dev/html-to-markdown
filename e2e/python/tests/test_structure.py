...
# alef:hash:34ae7b7a80215097cb00e84000010d541943c65eb22eaaa5630daf447a981b2f
...
def test_structure_code_block() -> None:
    ...
    assert (result.document.nodes if result.document else None) is not None and (not hasattr(result.document.nodes if result.document else None, "__len__") or len(result.document.nodes if result.document else None) > 0)
