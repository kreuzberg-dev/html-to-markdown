...
# alef:hash:7b576cc22249f4c3c6e9c8054057457e366b5d3a744c35b41f9cd0614fa0627e
...
def test_structure_code_block() -> None:
    ...
    assert result.document.nodes is not None and (not hasattr(result.document.nodes, "__len__") or len(result.document.nodes) > 0)  # noqa: S101
