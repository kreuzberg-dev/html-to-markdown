...
# alef:hash:7826f6e4dcf31a17d477a20c40354814885393a17454e6f9eaf2bb4e66834f25
...
def test_options_extract_metadata_true() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.title == "Test Page"  # noqa: S101
    assert result.metadata.document.description == "A test page"  # noqa: S101
...
def test_options_output_format_plain() -> None:
    ...
    assert result.content is not None  # noqa: S101
    assert "text." in result.content  # noqa: S101
    assert result.content is None or "**bold**" not in result.content  # noqa: S101
