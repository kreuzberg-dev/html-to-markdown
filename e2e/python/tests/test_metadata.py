...
# alef:hash:8a7cbf1f3e06cf6464e75a1d4998c52455c629d603efe4dc76b2bd2c07effde4
...
def test_metadata_author_meta() -> None:
    ...
    assert result.metadata.document.author == "Jane Doe"  # noqa: S101
...
def test_metadata_canonical_url() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.canonical_url == "https://example.com/canonical-page"  # noqa: S101
...
def test_metadata_description_meta() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.description == "This is the page description."  # noqa: S101
...
def test_metadata_title_tag() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.title == "My Page"  # noqa: S101
...
def test_og_basic_tags() -> None:
    ...
    result = convert(html)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.open_graph.get("title") == "OG Title"  # noqa: S101
    assert result.metadata.document.open_graph.get("description") == "OG description text."  # noqa: S101
    assert result.metadata.document.open_graph.get("image") == "https://example.com/image.jpg"  # noqa: S101
...
def test_og_multiple_tags() -> None:
    ...
    result = convert(html)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.open_graph.get("title") == "Article Title"  # noqa: S101
    assert result.metadata.document.open_graph.get("type") == "article"  # noqa: S101
    assert result.metadata.document.open_graph.get("url") == "https://example.com/article"  # noqa: S101
    assert result.metadata.document.open_graph.get("site_name") == "Example Site"  # noqa: S101
...
def test_structured_data_json_ld() -> None:
    ...
    assert result.content is None or "application/ld+json" not in result.content  # noqa: S101
    assert result.content is None or "@context" not in result.content  # noqa: S101
    assert result.content is None or "schema.org" not in result.content  # noqa: S101
...
def test_structured_data_multiple_json_ld() -> None:
    ...
    assert result.content is None or "@context" not in result.content  # noqa: S101
    assert result.content is None or "BreadcrumbList" not in result.content  # noqa: S101
    assert result.content is None or "ListItem" not in result.content  # noqa: S101
...
def test_twitter_card_tags() -> None:
    ...
    result = convert(html)
    assert result.content is not None and (not hasattr(result.content, "__len__") or len(result.content) > 0)  # noqa: S101
    assert result.metadata.document.twitter_card.get("card") == "summary_large_image"  # noqa: S101
    assert result.metadata.document.twitter_card.get("title") == "Twitter Card Title"  # noqa: S101
    assert result.metadata.document.twitter_card.get("description") == "Twitter card description."  # noqa: S101
