...
# alef:hash:300ef354b3034f8586f26eb820e5864ebd823fe305760a6d9b92b5485da2b284
...
def test_hidden_content_aria_hidden_still_rendered() -> None:
    ...
    result = convert(html)
    assert result.content is not None  # noqa: S101
    assert "visible" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "still shown" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "also visible" in result.content  # noqa: S101
...
def test_hidden_content_display_none_dropped() -> None:
    ...
    result = convert(html)
    assert result.content is None or "secret hidden text" not in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "visible" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "also visible" in result.content  # noqa: S101
...
def test_hidden_content_noscript_element_dropped() -> None:
    ...
    result = convert(html)
    assert result.content is None or "secret noscript text" not in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "visible" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "also visible" in result.content  # noqa: S101
...
def test_hidden_content_template_element_dropped() -> None:
    ...
    result = convert(html)
    assert result.content is None or "secret template text" not in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "visible" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "also visible" in result.content  # noqa: S101
...
def test_hidden_content_visibility_hidden_dropped() -> None:
    ...
    result = convert(html)
    assert result.content is None or "secret hidden span" not in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "visible" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "also visible" in result.content  # noqa: S101
...
def test_visitor_deeply_nested_skip() -> None:
    ...
    assert result.content is None or "skip" not in result.content  # noqa: S101
    assert result.content is None or "Skip" not in result.content  # noqa: S101
...
def test_visitor_unknown_tag_preservation() -> None:
    ...
    assert result.content is None or "preserve_html" not in result.content  # noqa: S101
...
def test_xss_onclick_handler_removed() -> None:
    ...
    assert result.content is None or "onclick" not in result.content  # noqa: S101
    assert result.content is None or "onmouseover" not in result.content  # noqa: S101
    assert result.content is None or "alert(" not in result.content  # noqa: S101
    assert result.content is None or "steal_data" not in result.content  # noqa: S101
...
def test_xss_script_tag_stripped() -> None:
    ...
    assert result.content is None or "<script>" not in result.content  # noqa: S101
    assert result.content is None or "alert(" not in result.content  # noqa: S101
    assert result.content is None or "xss" not in result.content  # noqa: S101
...
def test_xss_svg_nested_script_stripped() -> None:
    ...
    assert result.content is None or "<script>" not in result.content  # noqa: S101
    assert result.content is None or "alert(" not in result.content  # noqa: S101
    assert result.content is None or "svg-xss" not in result.content  # noqa: S101
