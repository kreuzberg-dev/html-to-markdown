...
RSpec.describe 'edge-cases' do
  ...
  it 'hidden_content_aria_hidden_still_rendered: aria-hidden only hides content from assistive tech, not visually — it must still be rendered' do
  ...
  it 'hidden_content_display_none_dropped: Elements hidden via inline style="display:none" must not appear in the output' do
  ...
  it 'hidden_content_noscript_element_dropped: Content inside <noscript> only renders with scripting disabled and must not appear in the output' do
  ...
  it 'hidden_content_template_element_dropped: Content inside <template> is never rendered per the HTML spec and must not appear in the output' do
  ...
  it 'hidden_content_visibility_hidden_dropped: Elements hidden via inline style="visibility:hidden" must not appear in the output' do
