...
RSpec.describe 'conversion' do
  it 'blockquote_code_block_indentation_preserved: Code block inside a blockquote keeps its line indentation' do
    ...
    expect(result.content.to_s.strip).to eq("> ```\n> line1\n>     line2 indented\n> ```\n".strip)
  ...
  it 'blockquote_nested_list_indentation_preserved: Nested list inside a blockquote keeps its continuation indentation' do
    ...
    expect(result.content.to_s.strip).to eq("> - item a\n>   * sub a1\n".strip)
  ...
  it 'blockquote_text_then_paragraph_gets_blank_line: Bare text followed by a paragraph inside a blockquote gets a blank-line separator instead of merging into one line' do
    ...
    expect(result.content.to_s.strip).to eq("> Just text, then\n>\n> a paragraph\n".strip)
  ...
  it 'table_ragged_row_fewer_cells_than_header: A data row with fewer cells than the header is padded to the declared column count' do
    ...
    expect(result.content.to_s.strip).to eq("| A | B | C |\n| --- | --- | --- |\n| 1 | 2 |   |\n".strip)
  ...
  it 'table_ragged_row_more_cells_than_header: A data row with more cells than the header widens the separator so no cell is silently dropped' do
    ...
    expect(result.content.to_s.strip).to eq("| A | B |   |\n| --- | --- | --- |\n| 1 | 2 | 3 |\n".strip)
