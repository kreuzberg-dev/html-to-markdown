...
fn test_hidden_content_aria_hidden_still_rendered() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"visible"#),
        "expected to contain: {}",
        r#"visible"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"still shown"#),
        "expected to contain: {}",
        r#"still shown"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"also visible"#),
        "expected to contain: {}",
        r#"also visible"#
    );
}
...
fn test_hidden_content_display_none_dropped() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"secret hidden text"#),
...
fn test_hidden_content_noscript_element_dropped() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"secret noscript text"#),
        "expected NOT to contain: {}",
...
fn test_hidden_content_template_element_dropped() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"secret template text"#),
        "expected NOT to contain: {}",
...
fn test_hidden_content_visibility_hidden_dropped() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"secret hidden span"#),
        "expected NOT to contain: {}",
...
fn test_visitor_deeply_nested_skip() {
    ...
    assert!(
        !format!("{:?}", _content).contains(r#"skip"#),
        "expected NOT to contain: {}",
        r#"skip"#
    );
    assert!(
...
fn test_visitor_unknown_tag_preservation() {
    ...
    assert!(
        !format!("{:?}", _content).contains(r#"preserve_html"#),
        "expected NOT to contain: {}",
        r#"preserve_html"#
    );
}
