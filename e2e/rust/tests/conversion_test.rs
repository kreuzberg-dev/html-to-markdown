...
// alef:hash:01b738660e8b3c40af912d7854c69e9352d08eaaab31a8fea9a6e51c24bc76d6
...
fn test_conversion_autolink_mailto() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"<a@b.com>"#, "equals assertion failed");
}
...
fn test_heading_h1() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"# Heading 1"#, "equals assertion failed");
}
...
fn test_heading_h2() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"## Heading 2"#, "equals assertion failed");
}
...
fn test_heading_h3() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"### Heading 3"#, "equals assertion failed");
}
...
fn test_heading_h4() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"#### Heading 4"#, "equals assertion failed");
}
...
fn test_heading_h5() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"##### Heading 5"#, "equals assertion failed");
}
...
fn test_heading_h6() {
    ...
    let result = convert(html, Some(options.clone())).expect("call failed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert_eq!(_content.to_string(), r#"###### Heading 6"#, "equals assertion failed");
}
