 ...
 * alef:hash:fa9f8e7802655a7ceb007e732254783f25b67b52a58c616f25a0867f00ad9fa5
...
void test_metadata_author_meta(void) {
    ...
    assert(metadata_author != NULL && strcmp(metadata_author, "Jane Doe") == 0 && "equals assertion failed");
...
void test_metadata_canonical_url(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_canonical_url != NULL && strcmp(metadata_canonical_url, "https://example.com/canonical-page") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_metadata_description_meta(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_description != NULL && strcmp(metadata_description, "This is the page description.") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_metadata_title_tag(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_title != NULL && strcmp(metadata_title, "My Page") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_og_basic_tags(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_open_graph_title != NULL && strcmp(metadata_open_graph_title, "OG Title") == 0 && "equals assertion failed");
    assert(metadata_open_graph_description != NULL && strcmp(metadata_open_graph_description, "OG description text.") == 0 && "equals assertion failed");
    assert(metadata_open_graph_image != NULL && strcmp(metadata_open_graph_image, "https://example.com/image.jpg") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_og_multiple_tags(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_open_graph_title != NULL && strcmp(metadata_open_graph_title, "Article Title") == 0 && "equals assertion failed");
    assert(metadata_open_graph_type != NULL && strcmp(metadata_open_graph_type, "article") == 0 && "equals assertion failed");
    assert(metadata_open_graph_url != NULL && strcmp(metadata_open_graph_url, "https://example.com/article") == 0 && "equals assertion failed");
    assert(metadata_open_graph_site_name != NULL && strcmp(metadata_open_graph_site_name, "Example Site") == 0 && "equals assertion failed");
    htm_free_string(content);
    free(metadata_open_graph_title);
...
void test_twitter_card_tags(void) {
    ...
    assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 && strcmp(content, "{}") != 0 && "expected non-empty value");
    assert(metadata_twitter_card != NULL && strcmp(metadata_twitter_card, "summary_large_image") == 0 && "equals assertion failed");
    assert(metadata_twitter_title != NULL && strcmp(metadata_twitter_title, "Twitter Card Title") == 0 && "equals assertion failed");
    assert(metadata_twitter_description != NULL && strcmp(metadata_twitter_description, "Twitter card description.") == 0 && "equals assertion failed");
    htm_free_string(content);
