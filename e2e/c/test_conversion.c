 ...
 * alef:hash:809cfb71f9dbb077be50cda0071c3cc84c52de296a49eb9276da9e4586d0df2c
...
void test_conversion_autolink_filename_not_autolinked(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[foobar.png](foobar.png)\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_mixed_filename_and_url(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[foobar.png](foobar.png) <https://www.heise.de>\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_relative_path_not_autolinked(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[/docs/intro.html](/docs/intro.html)\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
