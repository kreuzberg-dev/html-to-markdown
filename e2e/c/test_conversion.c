 ...
 * alef:hash:75c87bd22d43b7c14c4b013084afb5a27c5ca1ae36f72cccaacc7f2ccd8009e4
...
void test_blockquote_nested_list_indentation_preserved(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "> - item a\n>   * sub a1\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_blockquote_text_then_paragraph_gets_blank_line(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "> Just text, then\n>\n> a paragraph\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_filename_not_autolinked(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[foobar.png](foobar.png)") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_https_url(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "<https://example.com>") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_mailto(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "<a@b.com>") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_mixed_filename_and_url(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[foobar.png](foobar.png) <https://www.heise.de>") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_conversion_autolink_relative_path_not_autolinked(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "[/docs/intro.html](/docs/intro.html)") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h1(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "# Heading 1") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h2(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "## Heading 2") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h3(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "### Heading 3") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h4(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "#### Heading 4") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h5(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "##### Heading 5") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_heading_h6(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "###### Heading 6") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_paragraph_simple(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "Hello World") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_table_ragged_row_fewer_cells_than_header(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strcmp(content, "| A | B | C |\n| --- | --- | --- |\n| 1 | 2 |   |\n") == 0 && "equals assertion failed");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
