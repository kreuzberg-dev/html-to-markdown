...
// alef:hash:f358ebf4cb502dc8b18e390571d57b3f6df24d32774f83f15ac6ef0f177f31f7
...
final class OptionsTest extends TestCase
{
    ...
    public function test_options_extract_metadata_true(): void
    {
        ...
        $result = HtmlToMarkdown::convert("<html><head><title>Test Page</title><meta name='description' content='A test page'></head><body><p>Content</p></body></html>", $options);
            ...
            $this->assertNotSame('', ($result->content ?? null) ?? '', 'expected non-empty value');
            $this->assertEquals("Test Page", $result->getMetadata()->getDocument()->title);
            $this->assertEquals("A test page", $result->getMetadata()->getDocument()->description);
