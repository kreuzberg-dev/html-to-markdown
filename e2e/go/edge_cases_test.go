...
// alef:hash:d9d21fda0cc09b565d65c1efa0074718fc935eb3a37d182d0ad8894f31688899
...
func Test_XssOnclickHandlerRemoved(t *testing.T) {
	...
	if strings.Contains(string(*result.Content), `onclick`) {
		t.Errorf("expected NOT to contain %s, got %v", `onclick`, result.Content)
	}
	if strings.Contains(string(*result.Content), `onmouseover`) {
		t.Errorf("expected NOT to contain %s, got %v", `onmouseover`, result.Content)
	}
	if strings.Contains(string(*result.Content), `alert(`) {
		t.Errorf("expected NOT to contain %s, got %v", `alert(`, result.Content)
	}
	if strings.Contains(string(*result.Content), `steal_data`) {
...
func Test_XssScriptTagStripped(t *testing.T) {
	...
	if strings.Contains(string(*result.Content), `xss`) {
...
func Test_XssSvgNestedScriptStripped(t *testing.T) {
	...
	if strings.Contains(string(*result.Content), `svg-xss`) {
