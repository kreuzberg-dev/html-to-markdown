...
// alef:hash:0689421a9a56cf9acb331791729d20ff3b968d8647a87690f579304813ea9bdb
...
func Test_OgBasicTags(t *testing.T) {
	...
	if result.Metadata.Document.OpenGraph["title"] == nil || string(result.Metadata.Document.OpenGraph["title"]) != `OG Title` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.OpenGraph["title"])
	}
	if result.Metadata.Document.OpenGraph["description"] == nil || string(result.Metadata.Document.OpenGraph["description"]) != `OG description text.` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.OpenGraph["description"])
	}
	if result.Metadata.Document.OpenGraph["image"] == nil || string(result.Metadata.Document.OpenGraph["image"]) != `https://example.com/image.jpg` {
...
func Test_OgMultipleTags(t *testing.T) {
	...
	if result.Metadata.Document.OpenGraph["title"] == nil || string(result.Metadata.Document.OpenGraph["title"]) != `Article Title` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.OpenGraph["title"])
	}
	if result.Metadata.Document.OpenGraph["type"] == nil || string(result.Metadata.Document.OpenGraph["type"]) != `article` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.OpenGraph["type"])
	}
	if result.Metadata.Document.OpenGraph["url"] == nil || string(result.Metadata.Document.OpenGraph["url"]) != `https://example.com/article` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.OpenGraph["url"])
	}
	if result.Metadata.Document.OpenGraph["site_name"] == nil || string(result.Metadata.Document.OpenGraph["site_name"]) != `Example Site` {
...
func Test_TwitterCardTags(t *testing.T) {
	...
	if result.Metadata.Document.TwitterCard["card"] == nil || string(result.Metadata.Document.TwitterCard["card"]) != `summary_large_image` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.TwitterCard["card"])
	}
	if result.Metadata.Document.TwitterCard["title"] == nil || string(result.Metadata.Document.TwitterCard["title"]) != `Twitter Card Title` {
		t.Errorf("equals mismatch: got %v", result.Metadata.Document.TwitterCard["title"])
	}
	if result.Metadata.Document.TwitterCard["description"] == nil || string(result.Metadata.Document.TwitterCard["description"]) != `Twitter card description.` {
