...
public record GridCell(@JsonProperty("content") String content,
  ...
  public static final class Builder {
    ...
    private int row;
    private int col;
    @JsonProperty("row_span") @Nullable private Integer rowSpan;
    @JsonProperty("col_span") @Nullable private Integer colSpan;
    @JsonProperty("is_header") @Nullable private Boolean isHeader;
    ...
    public GridCell build() {
      return new GridCell(content, row, col, rowSpan, colSpan, isHeader);
    }
  }
  // CPD-ON
}
