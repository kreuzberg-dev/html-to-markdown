 ...
 *
 * Represents {@code &lt;a&gt;} elements with parsed href values, text content,
 * and link type classification.
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = LinkMetadata.Builder.class)
public record
LinkMetadata(@JsonProperty("href") String href,
  ...
  public static final class Builder {
    ...
    public LinkMetadata build() {
      return new LinkMetadata(href, text, title, linkType, rel, attributes);
    }
  }
  // CPD-ON
}
