...
/**
 * Document-level metadata extracted from {@code &lt;head&gt;} and top-level
 * elements.
 *
...
public record DocumentMetadata(
  ...
  public static final class Builder {
    ...
    @JsonProperty("canonical_url") @Nullable private String canonicalUrl;
    @JsonProperty("base_href") @Nullable private String baseHref;
    ...
    @JsonProperty("meta_tags") private Map<String, String> metaTags = Map.of();
    ...
    public DocumentMetadata build() {
      return new DocumentMetadata(
          title, description, keywords, author, canonicalUrl, baseHref,
          language, textDirection, openGraph, twitterCard, metaTags);
    }
  }
  // CPD-ON
}
