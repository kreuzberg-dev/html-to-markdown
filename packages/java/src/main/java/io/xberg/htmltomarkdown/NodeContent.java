 ...
 *
 * Uses internally tagged representation ({@code "node_type": "heading"}) for
 * JSON serialization.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "node_type",
              visible = false)
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = NodeContent.Paragraph.class, name = "paragraph"),
      ...
      @JsonSubTypes.Type(value = NodeContent.DefinitionList.class,
                         name = "definition_list"),
      @JsonSubTypes.Type(value = NodeContent.DefinitionItem.class,
                         name = "definition_item"),
      @JsonSubTypes.Type(value = NodeContent.RawBlock.class,
                         name = "raw_block"),
      @JsonSubTypes.Type(value = NodeContent.MetadataBlock.class,
                         name = "metadata_block"),
...
public sealed interface NodeContent {
   ...
   */
  record Heading(@JsonProperty("level") byte level,
                 @JsonProperty("text") String text) implements NodeContent {}
  ...
  /**
   * A list container (ordered or unordered). Children are {@code ListItem}
   * nodes.
   */
  ...
  /**
   * A raw block preserved as-is (e.g. {@code &lt;script&gt;}, {@code
   * &lt;style&gt;} content).
   */
   ...
   */
  record MetadataBlock(@JsonProperty("entries")
                       java.util.List<MetadataEntry> entries)
      implements NodeContent {}
