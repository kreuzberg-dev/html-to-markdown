...
void *__swift_bridge__$ConversionOptions$new(
    ...
    void *exclude_selectors, void *tier_strategy, void *visitor);
...
void *__swift_bridge__$ConversionOptionsUpdate$new(
    void *heading_style, void *list_indent_type,
    struct __private__OptionUsize list_indent_width, void *bullets,
    void *strong_em_symbol, struct __private__OptionBool escape_asterisks,
    struct __private__OptionBool escape_underscores,
    struct __private__OptionBool escape_misc,
    struct __private__OptionBool escape_ascii, void *code_language,
    struct __private__OptionBool autolinks,
    struct __private__OptionBool default_title,
    struct __private__OptionBool br_in_tables,
    struct __private__OptionBool compact_tables, void *highlight_style,
    struct __private__OptionBool extract_metadata, void *whitespace_mode,
    struct __private__OptionBool strip_newlines,
    struct __private__OptionBool wrap, struct __private__OptionUsize wrap_width,
    struct __private__OptionBool convert_as_inline, void *sub_symbol,
    void *sup_symbol, void *newline_style, void *code_block_style,
    void *keep_inline_images_in, void *preprocessing, void *encoding,
    struct __private__OptionBool debug, void *strip_tags, void *preserve_tags,
    struct __private__OptionBool skip_images, void *url_escape_style,
    void *link_style, void *output_format,
    struct __private__OptionBool include_document_structure,
    struct __private__OptionBool extract_images,
    struct __private__OptionU64 max_image_size,
    struct __private__OptionBool capture_svg,
    struct __private__OptionBool infer_dimensions, void *max_depth,
    void *exclude_selectors, void *tier_strategy, void *visitor);
