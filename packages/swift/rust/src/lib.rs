...
// alef:hash:0c3d3e03d02e3f18e1ae981e3176fcf7f1f24a1feacec30bf2290ed88f73a4e7
...
#[allow(dead_code)]
fn __alef_code_block_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::CodeBlockStyle {
    match value {
        ...
        _ => panic!("unknown CodeBlockStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_heading_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::HeadingStyle {
    match value {
        ...
        _ => panic!("unknown HeadingStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_highlight_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::HighlightStyle {
    match value {
        ...
        _ => panic!("unknown HighlightStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_image_type_from_swift_string(value: &str) -> html_to_markdown_rs::metadata::ImageType {
    match value {
        ...
        _ => panic!("unknown ImageType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_link_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::LinkStyle {
    match value {
        "Inline" => html_to_markdown_rs::options::LinkStyle::Inline,
        "Reference" => html_to_markdown_rs::options::LinkStyle::Reference,
        _ => panic!("unknown LinkStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_link_type_from_swift_string(value: &str) -> html_to_markdown_rs::metadata::LinkType {
    match value {
        ...
        _ => panic!("unknown LinkType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_list_indent_type_from_swift_string(value: &str) -> html_to_markdown_rs::options::ListIndentType {
    match value {
        "Spaces" => html_to_markdown_rs::options::ListIndentType::Spaces,
        "Tabs" => html_to_markdown_rs::options::ListIndentType::Tabs,
        _ => panic!("unknown ListIndentType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_newline_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::NewlineStyle {
    match value {
        "Spaces" => html_to_markdown_rs::options::NewlineStyle::Spaces,
        "Backslash" => html_to_markdown_rs::options::NewlineStyle::Backslash,
        _ => panic!("unknown NewlineStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_node_type_from_swift_string(value: &str) -> html_to_markdown_rs::NodeType {
    match value {
        ...
        _ => panic!("unknown NodeType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_output_format_from_swift_string(value: &str) -> html_to_markdown_rs::options::OutputFormat {
    match value {
        ...
        _ => panic!("unknown OutputFormat variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_preprocessing_preset_from_swift_string(value: &str) -> html_to_markdown_rs::options::PreprocessingPreset {
    match value {
        ...
        _ => panic!("unknown PreprocessingPreset variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_structured_data_type_from_swift_string(value: &str) -> html_to_markdown_rs::metadata::StructuredDataType {
    match value {
        ...
        _ => panic!("unknown StructuredDataType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_text_direction_from_swift_string(value: &str) -> html_to_markdown_rs::metadata::TextDirection {
    match value {
        ...
        _ => panic!("unknown TextDirection variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_tier_strategy_from_swift_string(value: &str) -> html_to_markdown_rs::options::TierStrategy {
    match value {
        ...
        _ => panic!("unknown TierStrategy variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_url_escape_style_from_swift_string(value: &str) -> html_to_markdown_rs::options::UrlEscapeStyle {
    match value {
        "Angle" => html_to_markdown_rs::options::UrlEscapeStyle::Angle,
        "Percent" => html_to_markdown_rs::options::UrlEscapeStyle::Percent,
        _ => panic!("unknown UrlEscapeStyle variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_warning_kind_from_swift_string(value: &str) -> html_to_markdown_rs::WarningKind {
    match value {
        ...
        _ => panic!("unknown WarningKind variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_whitespace_mode_from_swift_string(value: &str) -> html_to_markdown_rs::options::WhitespaceMode {
    match value {
        "Normalized" => html_to_markdown_rs::options::WhitespaceMode::Normalized,
        "Strict" => html_to_markdown_rs::options::WhitespaceMode::Strict,
        _ => panic!("unknown WhitespaceMode variant: {}", value),
    }
}
