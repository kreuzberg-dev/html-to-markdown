...
// alef:hash:5cf55bc83eae70aeb701e6d1d4d7193283fb5b3abcde1cd520e1b931e3c3a892
...
public sealed class HtmlVisitorBridge : IDisposable {
    ...
    // Number of pointer-sized slots: user_data + free_string + 40 callbacks.
    private const int CallbackSlotCount = 42;
    ...
    private void BuildCallbacks() {
        ...
        WriteSlot(2, new VisitTextFn(VisitTextCallback));
        WriteSlot(3, new VisitElementStartFn(VisitElementStartCallback));
        WriteSlot(4, new VisitElementEndFn(VisitElementEndCallback));
        WriteSlot(5, new VisitLinkFn(VisitLinkCallback));
        WriteSlot(6, new VisitImageFn(VisitImageCallback));
        WriteSlot(7, new VisitHeadingFn(VisitHeadingCallback));
        WriteSlot(8, new VisitCodeBlockFn(VisitCodeBlockCallback));
        WriteSlot(9, new VisitCodeInlineFn(VisitCodeInlineCallback));
        WriteSlot(10, new VisitListItemFn(VisitListItemCallback));
        WriteSlot(11, new VisitListStartFn(VisitListStartCallback));
        WriteSlot(12, new VisitListEndFn(VisitListEndCallback));
        WriteSlot(13, new VisitTableStartFn(VisitTableStartCallback));
        WriteSlot(14, new VisitTableRowFn(VisitTableRowCallback));
        WriteSlot(15, new VisitTableEndFn(VisitTableEndCallback));
        WriteSlot(16, new VisitBlockquoteFn(VisitBlockquoteCallback));
        WriteSlot(17, new VisitStrongFn(VisitStrongCallback));
        WriteSlot(18, new VisitEmphasisFn(VisitEmphasisCallback));
        WriteSlot(19, new VisitStrikethroughFn(VisitStrikethroughCallback));
        WriteSlot(20, new VisitUnderlineFn(VisitUnderlineCallback));
        WriteSlot(21, new VisitSubscriptFn(VisitSubscriptCallback));
        WriteSlot(22, new VisitSuperscriptFn(VisitSuperscriptCallback));
        WriteSlot(23, new VisitMarkFn(VisitMarkCallback));
        WriteSlot(24, new VisitLineBreakFn(VisitLineBreakCallback));
        WriteSlot(25, new VisitHorizontalRuleFn(VisitHorizontalRuleCallback));
        WriteSlot(26, new VisitCustomElementFn(VisitCustomElementCallback));
        WriteSlot(27, new VisitDefinitionListStartFn(VisitDefinitionListStartCallback));
        WriteSlot(28, new VisitDefinitionTermFn(VisitDefinitionTermCallback));
        WriteSlot(29, new VisitDefinitionDescriptionFn(VisitDefinitionDescriptionCallback));
        WriteSlot(30, new VisitDefinitionListEndFn(VisitDefinitionListEndCallback));
        WriteSlot(31, new VisitFormFn(VisitFormCallback));
        WriteSlot(32, new VisitInputFn(VisitInputCallback));
        WriteSlot(33, new VisitButtonFn(VisitButtonCallback));
        WriteSlot(34, new VisitAudioFn(VisitAudioCallback));
        WriteSlot(35, new VisitVideoFn(VisitVideoCallback));
        WriteSlot(36, new VisitIframeFn(VisitIframeCallback));
        WriteSlot(37, new VisitDetailsFn(VisitDetailsCallback));
        WriteSlot(38, new VisitSummaryFn(VisitSummaryCallback));
        WriteSlot(39, new VisitFigureStartFn(VisitFigureStartCallback));
        WriteSlot(40, new VisitFigcaptionFn(VisitFigcaptionCallback));
        WriteSlot(41, new VisitFigureEndFn(VisitFigureEndCallback));
    }
