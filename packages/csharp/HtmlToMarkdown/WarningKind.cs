...
public enum WarningKind {
  ...
  /// format).
  /// </summary>
  [JsonPropertyName("image_extraction_failed")] ImageExtractionFailed,
  /// <summary>
  /// The input encoding was not recognized; fell back to UTF-8.
  /// </summary>
  [JsonPropertyName("encoding_fallback")] EncodingFallback,
  /// <summary>
  /// The input was truncated due to size limits.
  /// </summary>
  [JsonPropertyName("truncated_input")] TruncatedInput,
  /// <summary>
  /// The HTML was malformed but processing continued with best effort.
  /// </summary>
  [JsonPropertyName("malformed_html")] MalformedHtml,
  /// <summary>
  /// Sanitization was applied to remove potentially unsafe content.
  /// </summary>
  [JsonPropertyName("sanitization_applied")] SanitizationApplied,
  /// <summary>
  /// DOM traversal was truncated because `max_depth` was exceeded.
  /// </summary>
  [JsonPropertyName("depth_limit_exceeded")] DepthLimitExceeded,
}

/// <summary>
/// Custom JSON converter for <see cref="WarningKind"/> that respects explicit
/// variant names.
/// </summary>
internal sealed class WarningKindJsonConverter : JsonConverter<WarningKind> {
  public override WarningKind Read(ref Utf8JsonReader reader,
                                   Type typeToConvert,
  ...
  public override void Write(Utf8JsonWriter writer, WarningKind value,
                             JsonSerializerOptions options) {
