...
// alef:hash:6b72471b8c30cab5723f8e7ea0f6c657a317925f652d4df9e98b58d44913cabd
...
,
            ...
            exclude_selectors: val.exclude_selectors.map(|v| v.into_iter().collect()),
            tier_strategy: val.tier_strategy.as_deref().map(|s| match s { "auto" => html_to_markdown_rs::options::TierStrategy::Auto,"tier2" => html_to_markdown_rs::options::TierStrategy::Tier2,#[cfg(any (test , feature = "testkit"))]"tier1" => html_to_markdown_rs::options::TierStrategy::Tier1,other => {
    ext_php_rs::exception::PhpException::default(format!(
        "invalid value {other:?} for field 'tier_strategy' of TierStrategy: expected one of [auto, tier2, tier1]"
    ))
    .throw()
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("html_to_markdown", "3.12.0")
