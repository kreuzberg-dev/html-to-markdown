...
// alef:hash:c88d6b674becb5648382cf73cd4031cc35d06797baf124b5450047784e7ccbde
// alef:handle-abi:1
...
pub unsafe extern "C" fn htm_conversion_options_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::ConversionOptions>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_conversion_options_update_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::ConversionOptionsUpdate>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn htm_conversion_options_update_visitor(handle: AlefHandle) -> AlefHandle {
    catch_ffi_panic(0, || {
        if handle == 0 {
            return 0;
        }
        let result =
            with_handle::<html_to_markdown_rs::options::ConversionOptionsUpdate, _>(handle, |obj| match &obj.visitor {
                Some(val) => match insert_handle(val.clone()) {
                    Ok(handle) => handle,
                    Err(error) => {
                        set_handle_error(&error);
...
pub unsafe extern "C" fn htm_conversion_result_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::ConversionResult>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_document_metadata_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::DocumentMetadata>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_document_node_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::DocumentNode>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_document_structure_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::DocumentStructure>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_grid_cell_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::GridCell>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_header_metadata_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::HeaderMetadata>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_html_metadata_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::HtmlMetadata>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_image_dimensions_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::ImageDimensions>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_image_metadata_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::ImageMetadata>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_link_metadata_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::LinkMetadata>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_metadata_entry_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::MetadataEntry>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_node_context_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<SerializedHandle<html_to_markdown_rs::NodeContext<'static>>>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_preprocessing_options_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::PreprocessingOptions>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_preprocessing_options_update_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::PreprocessingOptionsUpdate>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_processing_warning_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::ProcessingWarning>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_structured_data_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::StructuredData>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_table_data_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::TableData>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_table_grid_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::TableGrid>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_text_annotation_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::TextAnnotation>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_visitor_handle_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::VisitorHandle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_annotation_kind_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::AnnotationKind>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_code_block_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::CodeBlockStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_heading_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::HeadingStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_highlight_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::HighlightStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_image_type_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::ImageType>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_link_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::LinkStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_link_type_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::LinkType>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_list_indent_type_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::ListIndentType>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_newline_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::NewlineStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_node_content_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::NodeContent>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_node_type_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::NodeType>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_output_format_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::OutputFormat>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_preprocessing_preset_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::PreprocessingPreset>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_structured_data_type_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::StructuredDataType>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_text_direction_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::metadata::TextDirection>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_tier_strategy_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::TierStrategy>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_url_escape_style_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::UrlEscapeStyle>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_warning_kind_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::WarningKind>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_whitespace_mode_free(handle: AlefHandle) {
    catch_ffi_panic((), || {
        if handle != 0 {
            if let Err(error) = remove_handle::<html_to_markdown_rs::options::WhitespaceMode>(handle) {
                set_handle_error(&error);
            }
        }
    })
...
pub unsafe extern "C" fn htm_visitor_free(visitor: AlefHandle) {
    catch_ffi_panic((), || {
        if visitor != 0 {
            if let Err(error) = remove_handle::<HtmVisitor>(visitor) {
                set_handle_error(&error);
            }
        }
    })
